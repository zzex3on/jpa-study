...
|4. 엔티티 매핑| ```2024.01.27``` - ```2024.02.03``` |[4. section](https://github.com/zzex3on/jpa-study/tree/main/4.%20section)
|5. 연관관계 매핑 기초| ```2024.02.05``` - ```ing``` |[5. section](https://github.com/zzex3on/jpa-study/tree/main/5.%20section)
|6. 다양한 연관관계 매핑| |
|7. 고급 매핑| |
|8. 프록시와 연관관계 관리| |
|9. 값 타입| |
